...
export default class SearchComponent extends LightningElement {
    ...
    @api labelName = 'Custom Lookup';
    @api helpText = 'HelpText para o que você precisar';
    @api readOnly = false;
    @api currentRecordId;
    @api placeholder = 'Pesquise aqui';
    @api createRecord;
    @api fields = ['Name'];
    @api displayFields = 'Name, Title, IsActive';
    ...
    handleSelect(event){
        ...
        console.log('Return from selectedRecord: ', this.selectedRecord);
        console.log('Return from selecteEvent: ', selectedEvent);

        let attributeChangeEvent = new FlowAttributeChangeEvent('recordTest', this.selectedRecord);
